...
- [x] **Phase 2: Backend Instrumentation** ([backend/app/Services/EventCollector.php](backend/app/Services/EventCollector.php) & [docs/backend_instrumentation.md](docs/backend_instrumentation.md))
